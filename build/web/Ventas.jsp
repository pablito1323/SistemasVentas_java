<%-- 
    Document   : Ventas
    Created on : 20 oct 2024, 1:37:53
    Author     : pablito
--%>
...
<html lang="en">
    ...
    <body>
                        ...
                        <form method="post" action="Controlador?menu=Ventas">
                            <div class="row">
                                <div class="col-md-6 d-flex">
                                    ...
                                    <input type="submit" name="accion" value="BuscarCliente"class="btn btn-outline-dark  ms-2">
                                </div>
                                <div class="col-md-6 d-flex">
                        ...
                        <form action="Controlador?menu=Ventas" method="post">
                            <div class="row">
                                <div class="col-md-6 d-flex form-group">
                                    ...
                                    <input type="submit" name="accion" value="BuscarProducto" class="btn btn-outline-dark ms-2" >
                                </div>
                                <div class="col-md-6 d-flex form-group">
       ...
       Downloaded by PABLO ALIAGA YAPU (paliagay@autonoma.edu.pe)
       lOMoARcPSD|14056440
        <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-
       DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
